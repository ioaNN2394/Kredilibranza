...
import styles from './FileUpload.module.css'; // Importar el archivo de CSS como un módulo
      ...
      <div className={styles.fileUploadCard}>
        ...
        {files.length > 0 && (
          <div className={styles.uploadedFilesList}>
            ...
            <ul>
              {files.map((fileObj) => (
                <li key={fileObj.id} className={styles.uploadedFileItem}>
                  ...
                  <Button
                    ...
                    className={`${styles.removeButton} flex items-center`}
                  >
                    <X size={20} />
